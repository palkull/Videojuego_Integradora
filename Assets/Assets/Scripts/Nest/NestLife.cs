...
public class NestLife : MonoBehaviour
{
    ...
    public Action<int> NestTomoDaño; // Event to notify when the player takes damage
    public Action<int> NestCuroVida;
    ...
    public void TomarDaño(int cantidadDeDaño)
    {
        ...
        NestTomoDaño?.Invoke(vidaActual);
    ...
    public void CurarVida(int Curacion)
    {
        ...
        NestCuroVida?.Invoke(vidaActual);
